const { Order, Store, sequelize } = require("../../models");
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        status: order.status,
        instructions:
          "Show this OTP at the store counter to collect your order",
      },
    });
  } catch (err) {
  ...
  try {
    ...
    res.json({
      ...
      data: {
        ...
        otp: order.deliveryPickupOtp,
        instructions:
          "Show this OTP at the store counter to collect items for delivery",
      },
    });
  } catch (err) {
